...
mod tests{
    ...
    fn read_file_with_one_line_test_001() {
        let file = read_file("C:/Users/Julieta/projects/concurrency/Concurrency_Correa_Iglesias/grep/grep_engine/tests/test_001.txt").unwrap();
    ...
    fn read_file_with_two_lines_test_002(){
        let file = read_file("C:/Users/Julieta/projects/concurrency/Concurrency_Correa_Iglesias/grep/grep_engine/tests/test_002.txt").unwrap();
        let mut expected: Vec<String> = Vec::new();
        expected.push("Hello, World!".to_string());
